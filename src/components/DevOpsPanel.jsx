  ...
  return (
    ...
    >
      ...
      <div
        style={{
          background:
            "linear-gradient(90deg, #0a0f1a 60%, var(--background-color) 100%)",
        ...
        >
          ...
          >
            <div
              ...
              data-share-badge-id="71239887-1422-465a-8bbf-9c0efdbf44cc"
      ...
      >
        <span style={{ color: "var(--prompt-line-user)", fontWeight: 600 }}>
          Showcasing AWS skills
        </span>{" "}
        —
        <br />
        Each badge above is earned and verified via{" "}
        <a
