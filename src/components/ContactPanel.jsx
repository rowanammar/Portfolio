  ...
  return (
    <div className="contact-panel-outer">
      ...
      <div className="contact-panel-inner">
        ...
        {/* CV */}
      <div className="light-button cv">
        <a href="/Rawan_CV.pdf" target="_blank" rel="noopener noreferrer">
          <button className="bt">
            <div className="light-holder">
              <div className="dot"></div>
              <div className="light cv"></div>
            </div>
            <div className="button-holder">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                ...
                fill="#fff"
              >
                <path d="M19 9h-4V3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V11c0-1.1-.9-2-2-2zm-6-4.5l4.5 4.5H13V4.5zM8 14h8v2H8v-2zm0-4h8v2H8v-2z" />
              </svg>
              <p>My CV</p>
            </div>
          </button>
